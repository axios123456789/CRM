  ...
  <div id="workplace">
    <div style="width: 1000px; margin-left: 100px">
      ...
      <div style="width: 450px; float: left;">
        ...
        <input type="text" class="form-control" id="create-amount" style="width: 350px; float: left" />
      </div>
      ...
      <div style="width: 450px; float: left; margin-top: 50px">
        ...
        <input type="text" class="form-control" id="create-expectedTradeDate" style="width: 350px; float: left" readonly/>
      </div>

      <div style="width: 500px; float: left; margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">客户名称&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal"
                                                  data-target="#searchActivityModal" onclick="searchCustomer()"
                                                  style="text-decoration: none;"><span
                class="glyphicon glyphicon-search"></span></a></label>
        <input type="hidden" id="create-customerId">
        <input type="text" class="form-control" id="create-customerName" placeholder="点击左边图标面搜索" style="width: 350px; float: left" readonly />
      </div>
      <div style="width: 450px; float: left;margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">阶段</label>
        <select class="form-control" id="create-stage" style="width: 350px; float: left">
          <option></option>
      ...
      <div style="width: 500px; float: left;margin-top: 50px">
        ...
        <select class="form-control" id="create-transactionType" style="width: 350px; float: left">
          <option></option>
      ...
      <div style="width: 450px; float: left; margin-top: 50px">
        ...
        <input type="text" class="form-control" id="create-possibility" style="width: 350px; float: left" readonly/>
      </div>

      <div style="width: 500px; float: left;margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">来源</label>
        <select class="form-control" id="create-source" style="width: 350px; float: left">
          <option></option>
      ...
      <div style="width: 450px; float: left; margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal"
                                                                                      data-target="#searchActivityModal" onclick="searchActivity()"
                                                                                      style="text-decoration: none;"><span
                class="glyphicon glyphicon-search"></span></a></label>
        <input type="hidden" id="create-activityId">
        <input type="text" class="form-control" id="create-activityName" placeholder="点击左边图标面搜索" style="width: 350px; float: left" readonly />
      </div>

      <div style="width: 500px; float: left; margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal"
                                                                                      data-target="#searchActivityModal" onclick="searchContact()"
                                                                                      style="text-decoration: none;"><span
                class="glyphicon glyphicon-search"></span></a></label>
        <input type="hidden" id="create-contactId">
        <input type="text" class="form-control" id="create-contactName" placeholder="点击左边图标面搜索" style="width: 350px; float: left" readonly />
      </div>
      <div style="width: 450px; float: left; margin-top: 50px">
        <label style="width: 100px; line-height: 40px; float: left">下次联系时间</label>
        <input type="text" class="form-control" id="create-nextContactTime" style="width: 350px; float: left" readonly/>
      </div>
