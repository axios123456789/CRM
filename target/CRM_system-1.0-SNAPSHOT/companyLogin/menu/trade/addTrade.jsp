...
<%--            警告消息--%>
            ...
            <div style="width: 450px; float: left; margin-top: 50px">
                ...
                <input type="text" class="form-control" id="create-expectedTradeDate" style="width: 350px; float: left"
                       readonly/>
            </div>
            ...
            <div style="width: 500px; float: left; margin-top: 50px">
                ...
                <input type="text" class="form-control" id="create-customerName" placeholder="点击左边图标面搜索"
            ...
            <div style="width: 450px; float: left; margin-top: 50px">
                ...
                <input type="text" class="form-control" id="create-possibility" style="width: 350px; float: left"
                       readonly/>
            </div>
            ...
            <div style="width: 450px; float: left; margin-top: 50px">
                ...
                <input type="text" class="form-control" id="create-activityName" placeholder="点击左边图标面搜索"
                       style="width: 350px; float: left" readonly/>
            </div>
            ...
            <div style="width: 500px; float: left; margin-top: 50px">
                ...
                <input type="text" class="form-control" id="create-contactName" placeholder="点击左边图标面搜索"
                       style="width: 350px; float: left" readonly/>
            </div>
            <div style="width: 450px; float: left; margin-top: 50px">
                <label style="width: 100px; line-height: 40px; float: left">下次联系时间</label>
                <input type="text" class="form-control" id="create-nextContactTime" style="width: 350px; float: left"
                       readonly/>
            </div>

            <div style="width: 1000px; float: left; margin-top: 50px;">
                <label style="width: 100px;  float: left">描述</label>
                <textarea class="form-control" rows="4" id="create-description"
                          style="width: 900px; float: left"></textarea>
            </div>

            <div style="width: 1000px; float: left; margin-top: 50px;">
                <label style="width: 100px;  float: left">联系纪要</label>
                <textarea class="form-control" rows="4" id="create-contactMinute"
                          style="width: 900px; float: left"></textarea>
            </div>
            ...
            <div style="width: 1000px; float: left; margin-top: 50px; margin-bottom: 100px">
                ...
                <button type="button" class="btn btn-primary" onclick="add()" style="width: 400px; float: left">创建
                </button>
            </div>
...
<script>
    ...
    $("#varyTable tbody").on("click","input[name='allSource']", function (){
        ...
        if ($("#vary-source .modal-header h4").text() == "客户列表"){
            ...
            $("#create-customerId").val(id);
            $("#create-customerName").val(name);
    ...
    //创建
    function add() {
        if ($("#create-customerId").val() == "" || $("#create-customerId").val() == null){
            $("#msg-text").text("客户名称不能为空！");
            $("#massage").show();
        }else if ($("#create-activityId").val() == "" || $("#create-activityId").val() == null){
            $("#msg-text").text("市场活动源不能为空！");
            $("#massage").show();
        }else if ($("#create-contactId").val() == "" || $("#create-contactId").val() == null){
